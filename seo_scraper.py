...
if __name__ == "__main__":
    ...
    _fetch_img_btn = ttk.Button(_url_frame, text="Fetch Images", command=fetch_url)
    _fetch_img_btn.grid(row=0, column=1, sticky=W, padx=5)

    # New button to fetch title
    _fetch_title_btn = ttk.Button(_url_frame, text="Fetch Title", command=fetch_title)
    _fetch_title_btn.grid(row=1, column=0, sticky=W, padx=5, pady=5)

    # New button to fetch external links
    _fetch_links_btn = ttk.Button(_url_frame, text="Fetch Links", command=fetch_links)
    _fetch_links_btn.grid(row=1, column=1, sticky=W, padx=5, pady=5)
